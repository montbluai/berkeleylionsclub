        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <h1 className="text-4xl md:text-5xl mb-4" style={{ color: '#1740a5' }}>
              Privacy <span style={{ color: '#f2ca47' }}>Policy</span>
            </h1>
          ...
          <div className="prose prose-lg max-w-none">
            {/* LCI Privacy Policy Notice */}
            <div className="bg-blue-50 border-l-4 rounded-lg p-6 mb-8" style={{ borderColor: '#1740a5' }}>
              <h2 className="mt-0" style={{ color: '#1740a5' }}>Lions Clubs International Privacy Policy</h2>
              <p className="text-gray-700 mb-4">
                Berkeley Lions Club is a chartered member of Lions Clubs International (LCI). We follow the privacy policy established by our parent organization to ensure consistent protection of member, donor, and volunteer information across the global Lions network.
              </p>
              <a
